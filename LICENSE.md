# ByByte.DIY Licensing Policy

This document is the **canonical licensing reference** for the ByByte-diy organization and the `.github` repository. Individual project repositories may include their own `LICENSE` file; when in doubt, use the rules below and the license file in that repository.
...
| --------- | ------- | ---------- |
| Software and firmware | [MIT License](https://opensource.org/license/mit) | Source code, libraries, firmware, scripts, CI configs |
| Hardware and PCB designs | [CERN Open Hardware License Version 2 — Strongly Reciprocal (CERN-OHL-S v2)](https://ohwr.org/cern_ohl_s_v2.txt) | Schematics, PCB layouts, BOMs, mechanical CAD released as hardware |
| Documentation and lessons | [Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)](https://creativecommons.org/licenses/by-sa/4.0/) | Markdown docs, tutorials, slides, course materials, images released as documentation |
...
Open-source and open-hardware licenses **do not** grant permission to use ByByte.DIY™ names, logos, or other trademarks in a way that suggests official endorsement, certification, or affiliation.
