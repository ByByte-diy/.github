...
Різні частини екосистеми ByByte можуть використовувати різні ліцензії. Канонічна політика — у **[LICENSE](https://github.com/ByByte-diy/.github/blob/main/LICENSE.md)** (англомовна версія). Деталі також у `LICENSE`-файлах відповідних репозиторіїв.
