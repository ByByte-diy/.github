...
Різні частини екосистеми ByByte можуть використовувати різні ліцензії. Канонічна політика — у **[LICENSE](LICENSE.md)** (англомовна версія). Деталі також у `LICENSE`-файлах відповідних репозиторіїв.
